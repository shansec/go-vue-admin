...
func (i *initMenu) InitData(ctx context.Context) (cont context.Context, err error) {
	...
	menus := []model.SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 3, Path: "package", Name: "Package", Component: "views/tools/sys-autocode/index.vue", Sort: 11, Meta: model.Meta{Title: "自动化包", Icon: "add-doc", Affix: false}},

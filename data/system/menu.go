...
func (i *initMenu) InitData(ctx context.Context) (cont context.Context, err error) {
	...
	menus := []model.SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 2, Path: "user", Name: "User", Component: "views/authorize/sys-user/index.vue", Sort: 1, Meta: model.Meta{Title: "用户管理", Icon: "user", Affix: false}},
		{MenuLevel: 0, Hidden: false, ParentId: 2, Path: "api", Name: "Api", Component: "views/authorize/sys-api/index.vue", Sort: 2, Meta: model.Meta{Title: "api 管理", Icon: "api", Affix: false}},
		{MenuLevel: 0, Hidden: false, ParentId: 2, Path: "dept", Name: "Dept", Component: "views/authorize/sys-dept/index.vue", Sort: 3, Meta: model.Meta{Title: "部门管理", Icon: "tree", Affix: false}},

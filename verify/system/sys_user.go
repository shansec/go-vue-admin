...
var (
	...
	LoginVerify          = utils.Rules{"CaptchaId": {utils.NotEmpty()}, "Username": {utils.NotEmpty()}, "Password": {utils.NotEmpty()}}
	RegisterVerify       = utils.Rules{"Username": {utils.NotEmpty()}, "NickName": {utils.NotEmpty()}, "Password": {utils.NotEmpty()}, "Phone": {utils.NotEmpty()}}
